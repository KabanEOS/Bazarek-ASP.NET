...
namespace Shop.UI.Controllers
{
    ...
    public class CartController : Controller
    {
            ...
            [FromServices] AddToCart addToCart)
        {
            ...
            if (success)
            {
                return Ok("Produkt dodano do koszyka");
            }

            return BadRequest("Dodawanie do koszyka nie udało się");
        }
            ...
            [FromServices] RemoveFromCart removeFromCart)
        {
            ...
            if (success)
            {
                return Ok("Produkt usunięto z koszyka");
            }

            return BadRequest("Usunięcie z koszyka nie udało się");
        }
